...
public class ApagSupervisorActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, SearchView.OnQueryTextListener {

    private Toolbar toolbar;
    private DrawerLayout drawer;
    private CircleImageView avatar;
    private SessionManager sessionManager;
    private TextView navdisplay_name, navid_user, navid_city, superviseur_name, sitename_id_city, all, active, standby;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apag_supervision);
        ...
        if(sessionManager.getIs_logged()){
            ...
            sitename_id_city.setText(sessionManager.getCode_sap() + " / " + sessionManager.getId_city());
            navid_user.setText(sessionManager.getCode_sap());
            navid_city.setText(sessionManager.getId_city());

            if(!sessionManager.getId_animateur_site().equals("")
                    && !sessionManager.getId_animateur_site().equals("0")
                    && !sessionManager.getId_animateur_site().equals("admin")){
                superviseur_name.setText(sessionManager.getSuperviseur_name());
            }else{
                superviseur_name.setText(sessionManager.getDisplay_name());
            }
            all.setText(sessionManager.getNb_totale());
            active.setText(sessionManager.getNb_active());
            standby.setText(sessionManager.getNb_standby());
        }
        ...
        all_list_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ApagSupervisorAllActivity.class);
    ...
    private void initialiseVars(){
        ...
        superviseur_name = findViewById(R.id.superviseur_name);
        sitename_id_city = findViewById(R.id.sitename_city);
    ...
    public void getPriceList(String id_animateur_site){
        ...
        request.getSupervisionPricesList(id_animateur_site, String.valueOf(sessionManager.getDAY_LIMIT_FOR_LISTING()), new PriceRequest.SupervisionPriceCallback() {
            @SuppressLint("SetTextI18n")
            @Override
